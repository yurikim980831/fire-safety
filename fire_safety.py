...
# =============================================================
# [섹션 5] 주요 소방시설 위치 (설치장소 & 주요역할 간격 넓힘 적용)
# =============================================================
...
st.markdown("""
    ...
    .facility-role-section {
        margin-top: 14px; /* 문장 간격을 여유 있게 확대 */
    }
    .facility-content ul {
        padding-left: 18px;
        margin: 6px 0 0 0;
...
# =============================================================
# [섹션 9] 최신 소방청 보도자료 (슬림한 스타일 커스텀 박스 적용)
# =============================================================
st.subheader("📰 최신 소방청 보도자료")

# 카드 상하 패딩 및 내부 여백을 줄인 커스텀 스타일
st.markdown("""
    <style>
    .news-card {
        border: 1px solid #e2e8f0;
        border-radius: 8px;
        padding: 10px 14px; /* 세로 padding을 축소하여 세로 크기 감소 */
        margin-bottom: 8px;
        background-color: #ffffff;
...
for rel in releases:
    st.markdown(f"""
        <div class="news-card">
            ...
            <a class="news-link" href="{rel['link']}" target="_blank">🔗 해당 소방청 보도자료 원문 바로가기</a>
        </div>
    """, unsafe_allow_html=True)
