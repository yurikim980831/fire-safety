...
# 전결 표 헤더/셀 가운데 정렬 공통 CSS
st.markdown("""
    <style>
    /* Streamlit DataFrame Header & Cell 가운데 정렬 */
...
# -------------------------------------------------------------
# 소방/안전 최신 보도자료 수집 함수 (백업 기본 리스트 포함)
# -------------------------------------------------------------
...
def fetch_safety_news():
    ...
    # 2차 시도: 크롤링 실패 시 백업 보도자료 노출 (리스트 끊김 방지)
    if not articles:
        articles = [
            {
...
# =============================================================
# [섹션 3] 사고대응 유관기관 비상연락체계 (첫 줄/제목 포함 가운데 정렬)
# =============================================================
...
# =============================================================
# [섹션 4] 25년 소방훈련 세부 시나리오 (모든 셀 및 헤더 가운데 정렬)
# =============================================================
...
def show_scenario_table(data):
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "조치내용": st.column_config.Column(width="large", alignment="center"),
...
# =============================================================
# [섹션 6] 소방/안전 보도자료 (항상 리스트업 되도록 수정)
# =============================================================
