...
def render_centered_table(df, col_widths=None):
    ...
    .centered-table th {
        ...
        padding: 8px 8px; /* 높이 줄임을 위해 패딩 축소 */
        border-bottom: 2px solid #e2e8f0;
        border-right: 1px solid #f1f5f9;
    }
    .centered-table td {
        text-align: center !important;
        padding: 6px 8px; /* 높이 줄임을 위해 패딩 축소 */
...
# =============================================================
# [섹션 4] 사고대응 유관기관 비상연락체계 (폰트/행높이 감소 반영)
# =============================================================
...
# =============================================================
# [섹션 6] 응급처치 가이드 (문구 수정 & 높이 동일화 반영)
# =============================================================
st.subheader("💚 응급처치 가이드 (CPR 및 AED 사용법)")

# 높이 통일을 위한 Flexbox 커스텀 스타일
st.markdown("""
    <style>
    .first-aid-box {
        border: 1px solid #e2e8f0;
...
# =============================================================
# [섹션 8] 소방안전관리 연간 일정 (참고 멘트 폰트 축소 반영)
# =============================================================
